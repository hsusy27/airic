...
const SITE = {
  ...
  rules: [
    ...
    },
    {
      ...
      title: '社交工程演練',
      summary: '其他',
      img: 'assets/img/rule3.png',  // 👈 新增這行：放圖片網址（沒有圖片的項目不寫這行即可） 
      body: [
        '需填寫個資保護與資通安全認知宣導考題(掃描且主任確認)+郵件設定截圖。',
        '檔案存放位置:public\中心業務\各類SOP\社交工程演練。',
      ],
    },
         {
      cat: 'security',
    ...
    },
    {
      ...
      catLabel: '相關路徑',
      title: '常用行政表單路徑',
      summary: '耗材申請、設備借用、門禁卡補發、經費請款。',
      body: [
        '耗材申請 → 可以前往院內系統中「衛材申請作業」進行小領單申請',
        '設備借用 → 通知行政組並前往「設備借用系統」進行申請',
        '門禁卡補發 → 需自行前往人事室申請',
